...
export LD_LIBRARY_PATH=${HOME}/clang/clang-r328903/lib64:$LD_LIBRARY_PATH
DEFCONFIG="df_defconfig"
...
function make_boot {
		cp -vr $ZIMAGE_DIR/Image.lz4-dtb ~/android/AK-OnePone-AnyKernel2/zImage
}


function make_zip {
		cd ~/android/AK-OnePone-AnyKernel2/
...
case "$cchoice" in
	y|Y )
		clean_allAK-OnePone-AnyKernel2
		echo
